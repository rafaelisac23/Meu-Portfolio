    ...
    <div className="w-full flex flex-col">
      ...
      <div>
        ...
        <div className=" w-full flex flex-col  pb-10">
          ...
          >
            ...
            >
              ...
              <p className="mx-10 text-shadow mt-4 min-w-64 text-mintcream text-wrap text-justify  text-base font-Montserrat sm:text-lg md:text-md">
                Prazer, sou
                <TypeAnimation
        ...
        <motion.a
          ...
          className="text-white font-bold font-Montserrat  w-36 mt-8 ml-8 py-4 px-4 
